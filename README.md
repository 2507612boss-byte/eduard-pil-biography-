...
<h2> 9. 🆔 ORCID</h2>* #(Open Researcher and Contributor ID) — «Открытый идентификатор исследователя и участника») — незапатентованный буквенно-цифровой код, который однозначно идентифицирует научных авторов*</h2>
...
#13. 👑 Письма от монархов и политиков
<div class="gallery">
...
<h2>🎓👥 Учеба во ВТУЗЕ с 1967 по 1973 год</h2>
