...
<h2> 9. 🆔 ORCID *(Open Researcher and Contributor ID) — «Открытый идентификатор исследователя и участника») — незапатентованный буквенно-цифровой код, который однозначно идентифицирует научных авторов*</h2>
